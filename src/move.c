...
/*   Updated: 2023/08/24 17:15:19 by atuliara         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{	
	...
	new_ipx = (cubed->player.px + perpend_dx * (cubed->map.mapS / 4)) / cubed->map.mapS;
    new_ipy= (cubed->player.py + perpend_dy * (cubed->map.mapS / 4)) / cubed->map.mapS;
